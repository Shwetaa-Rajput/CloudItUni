...
function seva_lite_customize_register_general( $wp_customize ){
    ...
    $wp_customize->add_setting(
        'phone',
        array(
            'default'           => __( '+123-456-7890', 'seva-lite' ),
    ...
    $wp_customize->add_setting(
        'email',
        array(
            'default'           => __( 'mail@domain.com', 'seva-lite' ),
    ...
    $wp_customize->add_control(
        ...
        array(
            ...
            'description'   => __( 'This button shows only on header layouts 1,4,5&6.', 'seva-lite' ),
            'section'       => 'header_settings',
            'type'          => 'text',
        )
    );
